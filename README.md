...
- https://www.kaggle.com/datasets/devang16/ru-bridge-telegram/data

- https://www.kaggle.com/datasets/devang16/cluster-msgs-data

Note: These datasets are PRIVATE. Please email Devang Shah to get access.

## Citation

```
@misc{shah2024bridgingnodesnarrativeflows,
      title={Bridging Nodes and Narrative Flows: Identifying Intervention Targets for Disinformation on Telegram}, 
      author={Devang Shah and Hriday Ranka and Lynnette Hui Xian NG and Swapneel Mehta},
      year={2024},
      eprint={2411.05922},
      archivePrefix={arXiv},
      primaryClass={cs.CY},
      url={https://arxiv.org/abs/2411.05922}, 
}
```